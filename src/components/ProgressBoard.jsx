...
import CreateTask from './modal-group/create-modals/CreateTask'
...
export default function ProgressBoard() {
  ...
  return (
    <div className="flex flex-col bg-white rounded-md overflow-hidden h-full w-full">
      ...
      >
        {/* To-do Column */}
        <div className="flex flex-col border border-dotted border-gray-500 bg-gray-50 min-w-[16rem] w-full rounded-lg p-2  flex-1 min-h-0">
          <DisplayTitleSection
            title="To-do"
            className="text-sm"
        ...
        {/* In-progress Column */}
        <div className="flex flex-col border border-dotted border-blue-600 bg-blue-50 min-w-[16rem] w-full rounded-lg p-2 flex-1 min-h-0">
          <DisplayTitleSection
            title="In-progress"
            className="text-sm"
        ...
        {/* To-review Column */}
        <div className="flex flex-col border border-dotted border-yellow-600 bg-yellow-50 min-w-[16rem] w-full rounded-lg p-2 flex-1 min-h-0">
          <DisplayTitleSection
            title="To-review"
            className="text-sm"
        ...
        <div className="flex flex-col border border-dotted border-green-600 bg-green-50 min-w-[16rem] w-full rounded-lg p-2 flex-1 min-h-0">
          <DisplayTitleSection
            title="Finished"
            className="text-sm"
