      ...
      <div className="bg-white flex flex-col p-4 w-full max-w-screen-2xl h-[90vh] rounded-md shadow-2xl">
        ...
        {loading ? (
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Stat Card: To Review */}
            <div className="bg-violet-50 border-l-4 border-violet-500 p-4 rounded shadow-sm">
              <span className="text-violet-600 font-medium uppercase text-xs">To Review</span>
